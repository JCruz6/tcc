...
<big><a href="#" onclick="mostrar('{$nome}','{$email}','{$telefone}','{$cpf}','{$endereco}', '{$data_cadF}')" title="Mostrar Dados"><i class="fa fa-info-circle text-primary"></i></a></big>
...
<script type="text/javascript">
	...
	function mostrar(nome, email, telefone, cpf, endereco, data_cad){
