...
<big><a href="#" onclick="editar('{$id}','{$codigo}','{$nome}','{$categoria}','{$valor_venda}','{$fornecedor}','{$foto}','{$nivel_estoque}')" title="Editar Dados"><i class="fa fa-edit text-primary"></i></a></big>
...
<big><a href="#" onclick="gerarEtiquetas('{$id}', '{$codigo}', '{$valor_vendaF}', '{$nome}')" title="Gerar Etiquetas"><i class="fa fa-barcode" style="color:#000"></i></a></big>
...
<big><a href="#" onclick="grade('{$id}', '{$nome}')" title="Grade Produtos"><i class="fa fa-list" style="color:#056704"></i></a></big>
