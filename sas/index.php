					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="sidebar-menu">
							...
							<li class="treeview">
								...
								<ul class="treeview-menu">
									<li><a href="../rel/empresas_class.php" target="_blank"><i class="fa fa-angle-right"></i>Relação de Empresas</a></li>

									<li><a href="#" data-toggle="modal" data-target="#relReceber"><i class="fa fa-angle-right"></i>Relação de Recebimentos</a></li>

									<li><a href="#" data-toggle="modal" data-target="#relPagar"><i class="fa fa-angle-right"></i>Relação de Despesas</a></li>

									<li><a href="#" data-toggle="modal" data-target="#relLucro"><i class="fa fa-angle-right"></i>Relação de Lucro</a></li>
