...
<body>	
	...
	<div class="titulo_cab titulo_img"><u>Recebimentos <?php echo $acao_rel ?> <?php echo $texto_pessoa ?>  </u></div>	
	<div class="data_img"><?php echo mb_strtoupper($data_hoje) ?></div>

	<img class="imagem" style="height: 50; width:auto" src="<?php echo $url_sistema ?>img/logo-rel.jpg">
...
$vencidas = 0;
		...
		if($pessoa != ""){
			$query = $pdo->query("SELECT * FROM receber where $busca >= '$dataInicial' and $busca <= '$dataFinal' and pago LIKE '$pago' and pessoa = '$pessoa' and tipo = 'Empresa' and empresa = '0' ORDER BY id desc");
		}else{
			$query = $pdo->query("SELECT * FROM receber where $busca >= '$dataInicial' and $busca <= '$dataFinal' and pago LIKE '$pago' and tipo = 'Empresa' and empresa = '0' ORDER BY id desc");
		}
